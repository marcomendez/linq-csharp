...
namespace Try101LinqSamples
{
    public class SetOperations
    {
        ...
        public int DistinctSyntax()
        {
            ...
            var uniqueFactors = factorsOf300;
        ...
        public int UnionOfQueryResults()
        {
            ...
            var uniqueFirstChars = productFirstChars;
        ...
        public int IntersectQueryResults()
        {
            ...
            var commonFirstChars = productFirstChars;
        ...
        public int DifferenceOfSets()
        {
            ...
            IEnumerable<int> aOnlyNumbers = numbersA;
        ...
        public int DifferenceOfQueries()
        {
            ...
            var productOnlyFirstChars = productFirstChars;
